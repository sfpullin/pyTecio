...
installed on your computer (minimum version required: 1.69.0, and versions
1.75.0 and above require a compiler that supports the C++14 standard), or have
...
I.  On Linux/Mac OS X
    ...
    B. Using make
     ...
     makefile with our distribution. For older GCC versions, you may have to
     delete the compile flag: -std=c++14
